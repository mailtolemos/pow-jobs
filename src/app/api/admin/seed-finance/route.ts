...
export async function POST() {
  ...
  for (const seed of FINANCE_SEED_SOURCES) {
  ...
  return NextResponse.json({
    ...
    errors,
    total_in_seed: FINANCE_SEED_SOURCES.length,
  });
}
