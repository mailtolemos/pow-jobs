-- PoW Jobs SQLite schema.
-- Fields match src/lib/types.ts. Complex fields (arrays) are stored as JSON.
...
CREATE TABLE IF NOT EXISTS candidates (
  ...
  dealbreakers TEXT NOT NULL,        -- JSON
  saved_job_ids TEXT NOT NULL,       -- JSON
  dismissed_job_ids TEXT NOT NULL    -- JSON
);
...
CREATE TABLE IF NOT EXISTS matches (
  ...
  failed_filters TEXT NOT NULL, -- JSON
...
CREATE TABLE IF NOT EXISTS interactions (
  ...
  candidate_id TEXT NOT NULL,
  job_id TEXT NOT NULL,
  kind TEXT NOT NULL, -- 'saved' | 'dismissed' | 'applied' | 'viewed'
  reason TEXT,
